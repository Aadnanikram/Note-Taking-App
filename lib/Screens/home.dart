...
import 'package:final_paper/Components/Animation.dart';
import 'package:final_paper/Data/models.dart';
import 'package:final_paper/screens/edit.dart';
import 'package:final_paper/screens/view.dart';
import 'package:final_paper/Services/Database.dart';
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isFlagOn ? Colors.greenAccent : Colors.transparent,
                  border: Border.all(
                    width: isFlagOn ? 2 : 1,
                    color:
                    isFlagOn ? Colors.blueGrey.shade700 : Colors.grey.shade300,
                  ),
    ...
    return Row(
      children: <Widget>[
        AnimatedContainer(
          duration: Duration(milliseconds: 200),
          curve: Curves.easeIn,
          margin: EdgeInsets.only(top: 8, bottom: 32, left: 100),
